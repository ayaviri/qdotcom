...
// Represents the result of a player's turn with relevant information for the referee and the player
// that
// conducted the turn
public class TurnResult {
    ...
    public static class Builder {
        ...
        // turnAction must exist for every turn result and thus is passed into the builder upon
        // construction
    ...
    public String toString() {
        return String.format(
                ...
                this.placedAllTiles, this.newTiles, this.turnAction);
    }
}
