...
import ayaviri.visuals.PlayerStateImage;
import ayaviri.visuals.PlayersImage;
...
class Players {
    ...
    // NOTE: Assumes that the playerTiles map has tiles for every player in the passed in list of
    // players
    ...
    // Returns a list of the players' scores (including the active player) in the order they take
    // turns
    ...
    // NOTE: updating active player and removing active player should not both be invoked when
    // performing a turn
