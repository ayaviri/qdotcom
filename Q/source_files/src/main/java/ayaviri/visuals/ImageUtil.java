...
public class ImageUtil {
    ...
    public static BufferedImage joinHorizontal(
            BufferedImage bi1, BufferedImage bi2, int spaceBetween) {
        if (bi1.getWidth() == 1) {
            return bi2;
        }
        BufferedImage newImage =
                new BufferedImage(
                        bi1.getWidth() + bi2.getWidth() + spaceBetween,
    ...
    public static BufferedImage joinVertical(
            BufferedImage bi1, BufferedImage bi2, int spaceBetween) {
        if (bi1.getWidth() == 1) {
            return bi2;
        }
        BufferedImage newImage =
                new BufferedImage(
                        ...
                        bi1.getHeight() + bi2.getHeight() + spaceBetween,
                        BufferedImage.TYPE_INT_ARGB);
        Graphics2D g2 = newImage.createGraphics();
        g2.drawImage(bi1, null, 0, 0);
