...
// Represents a game playing strategy for the Q game that computes the next turn action based on the
...
public interface Strategy {
    ...
    // Given the state of the game, computes an exhaustive sequence of placements, a pass, or an
    // exchange
        ...
        switch (json) {
            ...
            default:
                throw new UnsupportedOperationException(
                        String.format("%s not a supported strategy", json));
        }
    }
}
