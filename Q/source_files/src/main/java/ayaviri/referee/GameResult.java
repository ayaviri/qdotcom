...
// Represents the results of a game: a pair of the names of the winning players and the names of the
// eliminated players
public class GameResult {
    ...
    public JsonElement toJson() {
        ...
        List<String> winningPlayers = this.winningPlayers;
        List<String> eliminatedPlayers = this.eliminatedPlayers;
