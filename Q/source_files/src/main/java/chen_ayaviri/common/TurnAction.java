...
public abstract class TurnAction implements JsonSerializable {
    ...
    // Performs this action on the game state for the given active player, populating
    ...
    // NOTE: does NOT set the legality of the builder to true since that is the assumption going
    // in to this method
    protected abstract void performCheckedOn(GameState state, PlayerState activePlayer, TurnResult.Builder turnResultBuilder);
