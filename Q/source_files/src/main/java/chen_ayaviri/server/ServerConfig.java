...
public class ServerConfig extends ADebuggableConfig {
    ...
    // The duration of the sign up confirmation period (between client connection and client confirmation)
    ...
    public JsonElement toJson() {
        ...
        serverConfigJson.add("wait-for-signup", new JsonPrimitive(this.confirmationPeriodInSeconds));
