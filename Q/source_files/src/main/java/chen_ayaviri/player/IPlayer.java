...
public interface IPlayer {
    ...
    // Calls upon this player to take their turn (returning a turn action), with the given public information from
    // the game state
    ...
    // Constructs an IPlayerProxy with the given name, strategy, and exception, using the given iterator over
    ...
    static IPlayer selectCommunicationFailurePlayer(String name, Strategy strategy, String jExn, Iterator<JsonElement> jActorSpecIterator) {
        if (jActorSpecIterator.hasNext()) {
