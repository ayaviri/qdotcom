...
import chen_ayaviri.map_representation.shapes.*;
...
public class Tile {
    ...
    private QColor getQColorFromString(String color) {
        switch (color) {
            ...
            default:
                throw new UnsupportedOperationException(String.format("The given color is not supported: %s\n", color));
        }
    }
    ...
    private AShape getShapeFromString(String shape) {
        switch (shape) {
            ...
            case "clover":
                return new Clover();
            default:
                throw new UnsupportedOperationException(String.format("The given shape is not supported: %s\n", shape));
        }
    }
    ...
    public boolean equals(Object other) {
        return other instanceof Tile && this.matchesColor((Tile) other) && this.matchesShape((Tile) other);
    }
