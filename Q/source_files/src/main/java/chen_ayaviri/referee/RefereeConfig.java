...
import chen_ayaviri.common.GameStateConfig;
...
public class RefereeConfig extends ADebuggableConfig {
    ...
    public RefereeConfig(GameState initialState, boolean quiet, GameStateConfig gameStateConfig, int perTurnTimeout, boolean hasObserverAttached) {
        super(quiet);
